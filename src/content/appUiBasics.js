  ...
  lessons: [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'ui-mode', sv: 'kinesiskt läge', hanzi: '中文模式', pinyin: 'zhōngwén móshì', uiKey: 'app.title', notesSv: 'Appens namn på kinesiska: Mandarin Mode.' },
      ],
    },
    {
      id: 'learning-actions',
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'ui-due', sv: 'att repetera', hanzi: '要复习', pinyin: 'yào fùxí', uiKey: 'status.due' },
        ...
        { id: 'ui-export', sv: 'exportera backup', hanzi: '导出备份', pinyin: 'dǎochū bèifèn', uiKey: 'action.export' },
        { id: 'ui-import', sv: 'importera backup', hanzi: '导入备份', pinyin: 'dǎorù bèifèn', uiKey: 'action.import' },
        { id: 'ui-reset', sv: 'nollställ', hanzi: '重置', pinyin: 'chóngzhì', uiKey: 'action.reset' },
      ],
    },
  ],
};
