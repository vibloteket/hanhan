export const appUiBasics = {
  ...
  lessons: [
    ...
    },
    {
      ...
      titleSv: 'Teknisk info: version och build',
      descriptionSv: 'Version, builddatum och asset-version i inställningarna.',
      unlocksUiKeys: ['term.version', 'term.build', 'term.buildDate', 'term.assetVersion'],
      practiceModes: ['type-pinyin'],
      items: [
