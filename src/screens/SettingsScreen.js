...
import { APP_LICENSE, APP_VERSION, ASSET_VERSION, BUILD_COMMIT, BUILD_DATE, CONTACT_EMAIL, SOURCE_URL } from '../buildInfo.js';
    ...
    <section class="screen settings-screen">
      ...
      <section class="screen panel about-panel">
        ...
        <dl class="about-list">
          ...
          <div><dt><${UiText} progress=${progress} id="term.sourceCode" /></dt><dd><a href=${SOURCE_URL} target="_blank" rel="noopener noreferrer">GitHub</a></dd></div>
